...
Random UnderSampling Boosting。Seiffert 等人 2010 年提出的集成方法，每一轮 AdaBoost 迭代之前先对训练集做一次随机欠采样让多数类与少数类等量，再在平衡子集上训练 base learner。在会计 ML 中由 Bao 等人 2020 推为不平衡舞弊检测的旗舰方法。
</SideNote>
